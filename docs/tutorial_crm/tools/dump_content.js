...
const out = {
    ...
    finStations: grab("FIN_STATIONS"),
    fin: grab("FIN"),
    finScreenCtx: grab("FIN_SCREEN_CTX"),
    finLessons: grab("FIN_LESSONS"),
    finMissions: grab("FIN_MISSIONS"),
    finM1Steps: grab("FIN_M1_STEPS"),
    finColumns: grab("FIN_COLUMNS"),
    finQa: grab("FIN_QA"),
    finQaSuggest: grab("FIN_QA_SUGGEST"),
    opsQa: grab("OPS_QA"),
