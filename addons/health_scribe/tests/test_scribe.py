...
class TestShellAssets(HttpCase):
    ...
    def test_shell_serves_scribe_assets_at_1_9_0(self):
        ...
        self.assertEqual(res.status_code, 200)
        body = res.text
        self.assertIn('scribe.css?v=1.16.0', body)
        self.assertIn('scribe.js?v=1.16.0', body)
        self.assertIn('1.16.0', body)
        # Co-resident shell modules pinned to the same bumped version.
        self.assertIn('daystrip.js?v=1.16.0', body)
        self.assertIn('telehealth.js?v=1.16.0', body)
        self.assertIn('ergo.css?v=1.16.0', body)
