...
window.PWAUtils = {
  ...
  i18n: {
    vi: {
      ...
      'Services:': 'Dịch vụ:',
      'Package:': 'Gói:',
      'Category of Service:': 'Loại dịch vụ:',
      ...
      'Diagnosis': 'Chẩn đoán',
      'Diagnosis:': 'Chẩn đoán:',
      'Enter clinical observations...': 'Nhập quan sát lâm sàng...',
      'Type here...': 'Nhập tại đây...',
      'Referring Doctor': 'Bác sĩ giới thiệu',
      'Call Referring Doctor': 'Gọi bác sĩ giới thiệu',
      ...
      'Discount Reason:': 'Lý do chiết khấu:',
      'Required: Explain discount': 'Bắt buộc: Giải thích lý do chiết khấu',
      ...
      'Loading field service orders...': 'Đang tải đơn dịch vụ hiện trường...',
      'Failed to load orders:': 'Không thể tải đơn:',
      'No Upcoming Orders': 'Không có đơn sắp tới',
      'No field service orders have been synced yet.': 'Chưa đồng bộ đơn dịch vụ hiện trường nào.',
      'No upcoming bookings found. All orders are in the past.': 'Không tìm thấy lịch hẹn sắp tới. Tất cả đơn đều đã qua.',
      'Scheduled:': 'Đã lên lịch:',
      'Past': 'Trước đây',
      'Past Bookings': 'Lịch hẹn trước đây',
      'View Upcoming': 'Xem lịch hẹn sắp tới',
      'Loading past bookings...': 'Đang tải lịch hẹn trước đây...',
      'Failed to load past bookings:': 'Không thể tải lịch hẹn trước đây:',
      'No Past Bookings': 'Không có lịch hẹn trước đây',
      'No past bookings found. All orders are upcoming.': 'Không tìm thấy lịch hẹn trước đây. Tất cả đơn đều sắp tới.',
      ...
      'Team management interface will be implemented here.': 'Giao diện quản lý đội nhóm sẽ được triển khai tại đây.',
    ...
    en: {
      ...
      'Diagnosis': 'Diagnosis',
      'Diagnosis:': 'Diagnosis:',
      'Enter clinical observations...': 'Enter clinical observations...',
      'Type here...': 'Type here...',
      'Referring Doctor': 'Referring Doctor',
      'Call Referring Doctor': 'Call Referring Doctor',
      'Goal of Care': 'Goal of Care',
      'Required Equipment': 'Required Equipment',
      'Intake Notes': 'Intake Notes',
      'Verification Notes': 'Verification Notes',
      'Discount Reason:': 'Discount Reason:',
      'Required: Explain discount': 'Required: Explain discount',
      ...
      'Loading field service orders...': 'Loading field service orders...',
      'Failed to load orders:': 'Failed to load orders:',
      'No Upcoming Orders': 'No Upcoming Orders',
      'No field service orders have been synced yet.': 'No field service orders have been synced yet.',
      'No upcoming bookings found. All orders are in the past.': 'No upcoming bookings found. All orders are in the past.',
      'Scheduled:': 'Scheduled:',
      'Past': 'Past',
      'Past Bookings': 'Past Bookings',
      'View Upcoming': 'View Upcoming',
      'Loading past bookings...': 'Loading past bookings...',
      'Failed to load past bookings:': 'Failed to load past bookings:',
      'No Past Bookings': 'No Past Bookings',
      'No past bookings found. All orders are upcoming.': 'No past bookings found. All orders are upcoming.',
      ...
      'Team management interface will be implemented here.': 'Team management interface will be implemented here.',
      'Sync Data': 'Sync Data',
    ...
    display: function(value, options = {}) {
      ...
      const mappedWhole = this.t(enumAliases[text.toLowerCase()] || text);
